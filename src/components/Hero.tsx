      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
        ...
        >
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <a
              href="#projects"
              className="px-6 py-3.5 text-xs font-semibold uppercase tracking-widest text-zinc-950 bg-white hover:bg-zinc-200 rounded-full transition-all duration-300 shadow-lg text-center flex items-center justify-center"
            >
            ...
            <a
              href="#contact"
              className="px-6 py-3.5 text-xs font-semibold uppercase tracking-widest text-zinc-200 hover:text-white bg-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-full transition-all duration-300 text-center flex items-center justify-center"
            >
          ...
          <div className="pt-4 flex items-center space-x-4">
            <a
              ...
              rel="noreferrer"
              aria-label="GitHub"
              className="p-2.5 rounded-full bg-zinc-900/90 border border-zinc-800 text-zinc-400 hover:text-white hover:border-zinc-700 transition-colors"
            >
        ...
        >
          <div className="relative group max-w-sm w-full">
            <div className="absolute -inset-1 bg-gradient-to-tr from-zinc-700 via-zinc-400 to-zinc-800 rounded-2xl opacity-20 blur-xl transition-all duration-500 pointer-events-none" />
