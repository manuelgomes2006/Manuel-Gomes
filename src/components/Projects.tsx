    ...
    <section id="projects" className="py-12 sm:py-20 lg:py-24 bg-[#09090b] border-t border-zinc-900/90 relative scroll-mt-20 sm:scroll-mt-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 sm:mb-10 gap-4 sm:gap-6">
          ...
          {/* Segmented Project Switcher (Optimized for Mobile) */}
          <div className="w-full sm:w-auto grid grid-cols-2 p-1 sm:p-1.5 rounded-xl sm:rounded-2xl bg-zinc-950 border border-zinc-800/90 shadow-2xl">
            {PERSONAL_DATA.projects.map((project, index) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-2.5 sm:px-4 py-2 sm:py-2.5 rounded-lg sm:rounded-xl text-[11px] sm:text-xs font-sans font-semibold tracking-wide transition-all duration-300 flex items-center justify-center space-x-1.5 sm:space-x-2 ${
                ...
                >
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute inset-0 rounded-lg sm:rounded-xl bg-zinc-800/90 border border-zinc-700/80 shadow-inner"
        ...
        <div className="rounded-2xl sm:rounded-3xl bg-zinc-950/90 border border-white/10 shadow-2xl overflow-hidden backdrop-blur-2xl">
          
          {/* Browser Header Bar */}
          <div className="px-3.5 sm:px-6 py-2.5 sm:py-3.5 bg-zinc-900/80 border-b border-zinc-800/80 flex items-center justify-between gap-2.5 sm:gap-4">
            ...
            <div className="flex-1 max-w-xl mx-auto flex items-center justify-between px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-full bg-zinc-950/90 border border-zinc-800 text-[10px] sm:text-xs font-mono text-zinc-400 shadow-inner min-w-0">
              ...
              <div className="lg:col-span-6 space-y-3 sm:space-y-5 text-left">
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3.5 w-full">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full sm:w-auto px-6 py-3 rounded-full bg-white hover:bg-zinc-200 text-zinc-950 text-xs font-bold uppercase tracking-wider transition-all duration-300 inline-flex items-center justify-center shadow-xl transform-gpu hover:scale-[1.02] active:scale-98"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full sm:w-auto px-6 py-3 rounded-full bg-zinc-900 border border-zinc-700 text-zinc-200 hover:text-white hover:bg-zinc-800 text-xs font-bold uppercase tracking-wider transition-all duration-300 inline-flex items-center justify-center shadow-md transform-gpu hover:scale-[1.02] active:scale-98"
                  >
